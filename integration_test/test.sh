...
sed -r 's/\"timestamp\":\"[0-9T:.+\-]+\"/\"timestamp\":\"2019-06-24T19:19:46.644943+01:00\"/g' test-result.json
sed -r 's/\"timestamp\":\"[0-9T:.+\-]+\"/\"timestamp\":\"2019-06-24T19:19:46.644943+01:00\"/g' test-result.json > test-result.tmp && mv test-result.tmp test-result.json
