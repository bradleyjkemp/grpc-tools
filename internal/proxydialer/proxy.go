...
type httpProxyFunc = func(req *url.URL) (*url.URL, error)
...
func mapAddress(ctx context.Context, proxyFunc httpProxyFunc, address string) (*url.URL, error) {
	url, err := proxyFunc(&url.URL{
		Scheme: "https",
		Host:   address,
	})
	if err != nil {
...
func NewProxyDialer(proxyFunc httpProxyFunc) func(context.Context, string) (net.Conn, error) {
	...
	return func(ctx context.Context, addr string) (conn net.Conn, err error) {
		var newAddr string
		proxyURL, err := mapAddress(ctx, proxyFunc, addr)
		if err != nil {
			if err != errDisabled {
				return nil, err
			}
